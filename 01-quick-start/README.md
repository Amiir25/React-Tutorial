...
JSX is a markup syntax that allows writing HTML markup inside JavaScript functions. Despite HTML, it strickts closing every element including self closing tags like <img />.
